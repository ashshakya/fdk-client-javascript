...
class Catalog {
    constructor(_conf) {
        ...
        this._relativeUrls = {
            ...
            getCollectionItemsBySlug: "/service/application/catalog/v2.0/collections/{slug}/items/",
            getCollectionDetailBySlug: "/service/application/catalog/v2.0/collections/{slug}/",
...
class Cart {
    ...
    * @param {Object} arg - arg object.
    * @param {string} arg.slug - A short, human-readable, URL-friendly identifier of a product. You can get slug value from the endpoint /service/application/catalog/v1.0/products/
    * @param {string} [arg.storeId] - Store uid of assigned store on PDP page. If not passed default first created ladder will be assigned
...
class Common {
    ...
    * @return {Promise<ApplicationResponse>} - success response
    **/
        searchApplication({
            authorization,
            query
            ...
            const { error } = CommonValidator.searchApplication().validate({ authorization,
            query
             },{ abortEarly: false });
            if (error) {
                return Promise.reject(new FDKClientValidationError(error));
...
class Configuration {
    ...
    * @return {Promise<AppStaffListResponse>} - success response
    **/
        getAppStaffList({
            pageNo,
            pageSize,
            ...
            const { error } = ConfigurationValidator.getAppStaffList().validate({ pageNo,
            pageSize,
            orderIncent,
            orderingStore,
            user
