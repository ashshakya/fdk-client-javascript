...
class Lead {
    ...
    **/
        createHistory({
            ...
            const { error } = LeadValidator.createHistory().validate({ id,
            body
             },{ abortEarly: false });
            if (error) {
                return Promise.reject(new FDKClientValidationError(error));
...
class User {
    constructor(_conf) {
        ...
        this._relativeUrls = {
            ...
            setFreshchatRestoreId: "/service/application/user/authentication/v1.0/user_store/freshchat-restore-id",
            getUserStore: "/service/application/user/authentication/v1.0/user_store/store",
    ...
    * @param {FreshchatRestoreIdRequestSchema} arg.body
    * @return {Promise<UserStoreSchema>} - success response
    **/
        setFreshchatRestoreId({
            body
            
        } = {}) {
            const { error } = UserValidator.setFreshchatRestoreId().validate({ body
             },{ abortEarly: false });
            if (error) {
                return Promise.reject(new FDKClientValidationError(error));
            }
            ...
            return APIClient.execute(
                    ...
                    "post",
                    constructUrl({
                        url: this._urls["setFreshchatRestoreId"],
                        params: {  }
                    }),
                    query,
                    body,
    ...
    **/
        getUserStore({
            ...
            const { error } = UserValidator.getUserStore().validate({  },{ abortEarly: false });
            if (error) {
                return Promise.reject(new FDKClientValidationError(error));
            }
            const query = {};
...
class Payment {
    constructor(_conf) {
        ...
        this._relativeUrls = {
            ...
            CheckCredit: "/service/application/payment/v1.0/credit-onboard/"
    ...
    **/
        CheckCredit({
            ...
            const { error } = PaymentValidator.CheckCredit().validate({ body
             },{ abortEarly: false });
            if (error) {
                return Promise.reject(new FDKClientValidationError(error));
            }
...
class Feedback {
    ...
    * @param {Object} arg - arg object.
    * @param {Array<string>} arg.ids - List of media ID
    ...
    **/
        deleteMedia({
            ...
            const { error } = FeedbackValidator.deleteMedia().validate({ ids
             },{ abortEarly: false });
            if (error) {
                return Promise.reject(new FDKClientValidationError(error));
            }
