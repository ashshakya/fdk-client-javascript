...
class User {
    constructor(_conf) {
        ...
        this._urls = {
            ...
            getFreshchatRestoreId: "/service/application/user/authentication/v1.0/user_store/freshchat-restore-id",
    ...
    **/
        getFreshchatRestoreId({
            ...
            const { error } = UserValidator.getFreshchatRestoreId().validate({ body
             },{ abortEarly: false });
            if (error) {
                return Promise.reject(new FDKClientValidationError(error));
            }
            ...
            return APIClient.execute(
                    ...
                    "post",
                    constructUrl({
                        url: this._urls["getFreshchatRestoreId"],
                        params: {  }
                    }),
                    query,
                    body,
