...
declare class Content {
     ...
     * @description: Use this API to retrieve a list of pages.
     */
    getPagesV2Paginator({ companyId, applicationId, pageSize }?: {
        companyId: string;
        applicationId: string;
        pageSize?: number;
    }): Paginator;
