...
const {
    ...
    */
    ...
    /**
        ...
        @property { CollectionImage } landscape_web
        
        @property { Array<CustomBanner> } [custombanner]
        
        @property { CollectionImage } landscape_mobile
        
        @property { CollectionImage } portrait_mobile
        
        @property { CollectionImage } portrait_web
...
class Catalog {
    ...
    * @param {Object} arg - arg object.
    * @param {string} arg.itemId - product id for which the custom_meta is assiciated.
    ...
    **/
        upsertAppProductMeta({
            ...
            const { error } = CatalogValidator.upsertAppProductMeta().validate({
                itemId,
            body
    ...
    * @param {number} [arg.uid] - Use this parameter to filter brands by  brand uid.
    ...
    **/
                getApplicationBrandsPaginator( { companyId, applicationId, department, pageSize, q, uid
                } = {}){
                const paginator = new Paginator();
                const callback = async () => {
                    const pageId = paginator.nextId;
