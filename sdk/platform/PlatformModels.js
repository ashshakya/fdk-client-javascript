    ...
    */
        ...
        static AvailablePageSchema(){
            ...
            return Joi.object({
                    ...
                    sections_meta: Joi.array().items(this.AvailablePageSectionMetaAttributes()),
        ...
        static FreshchatRestoreIdRequestSchema(){

            return Joi.object({
                
                    
                    freshchat_restore_id: Joi.string().allow(''),
        ...
        static ActionPage(){
            ...
            return Joi.object({
                    ...
                    params: Joi.object().pattern(/^/,Joi.array().items(Joi.string().allow(''))),
                    
                    query: Joi.object().pattern(/^/,Joi.array().items(Joi.string().allow(''))),
        ...
        static AnnouncementsResponseSchema(){
            ...
            return Joi.object({
                    ...
                    announcements: Joi.object().pattern(/^/,Joi.array().items(this.AnnouncementSchema())),
    ...
    */
        ...
        static PaymentModeList(){
            ...
            return Joi.object({
                    ...
                    intent_app: Joi.array().items(Joi.any()),
        ...
        static PaymentConfirmationRequest(){
            ...
            return Joi.object({
                    ...
                    payment_methods: Joi.array().items(this.MultiTenderPaymentMethod()).required(),
        ...
        static ShipmentTrackResponse(){
            ...
            return Joi.object({
                    ...
                    bag_list: Joi.array().items(this.ShipmentTrackResponseBagListItem()).required(),
        ...
        static ShipmentTrackResponseBagListItem(){
            ...
            return Joi.object({
                    ...
                    breakup_values: Joi.array().items(this.ShipmentTrackResponseBagListItemBreakValues()),
                    
                    statuses: Joi.array().items(this.ShipmentTrackResponseBagListItemStatuses()),
        ...
        static ShipmentTrackResponseBagListItemStatuses(){
            ...
            return Joi.object({
                    ...
                    progress_status: Joi.array().items(this.ShipmentTrackResponseBagListItemStatusesProgress()),
                    ...
                    tracking_list: Joi.array().items(this.ShipmentTrackResponseBagListItemStatusesTrack()),
        ...
        static ConfigurationListingFilter(){
            ...
            return Joi.object({
                    ...
                    attribute_config: Joi.array().items(this.ConfigurationListingFilterConfig()),
        ...
        static ProductListingDetail(){
            ...
            return Joi.object({
                    ...
                    grouped_attributes: Joi.array().items(this.ProductDetailGroupedAttribute()),
        ...
        static JobConfigDTO(){
            ...
            return Joi.object({
                    ...
                    integration_data: Joi.object().pattern(/^/,Joi.any()),
        ...
        static CompanyConfig(){
            ...
            return Joi.object({
                    ...
                    open_tags: Joi.object().pattern(/^/,Joi.any()),
        ...
        static DBConfig(){
            ...
            return Joi.object({
                    ...
                    optional_properties: Joi.object().pattern(/^/,Joi.string().allow('')),
        ...
        static DocMappingConfig(){
            ...
            return Joi.object({
                    ...
                    properties: Joi.object().pattern(/^/,Joi.any()),
        ...
        static EmailConfig(){
            ...
            return Joi.object({
                    ...
                    properties: Joi.object().pattern(/^/,Joi.string().allow('')),
        ...
        static HttpConfig(){
            ...
            return Joi.object({
                    ...
                    request_params: Joi.object().pattern(/^/,Joi.string().allow('')),
        ...
        static MongoDocConfig(){
            ...
            return Joi.object({
                    ...
                    find_query: Joi.object().pattern(/^/,Joi.any()),
                    
                    projection_query: Joi.object().pattern(/^/,Joi.any()),
                    
                    prop_bean_configs: Joi.array().items(this.PropBeanConfig()),
                    
                    aggregate_pipeline: Joi.array().items(Joi.object().pattern(/^/,Joi.any())),
        ...
        static PropBeanConfig(){
            ...
            return Joi.object({
                    ...
                    mapping: Joi.object().pattern(/^/,this.PropBeanConfig()),
                    
                    optional: Joi.boolean(),
                    
                    send: this.Send(),
                    
                    validations: Joi.array().items(Joi.object().pattern(/^/,Joi.any())),
        ...
        static StoreFilter(){
            ...
            return Joi.object({
                    ...
                    query: Joi.object().pattern(/^/,Joi.any()),
        ...
        static Restrictions(){
            ...
            return Joi.object({
                    ...
                    payments: Joi.object().pattern(/^/,this.PaymentModes()),
        ...
        static ItemCriteria(){
            ...
            return Joi.object({
                    ...
                    buy_expression: Joi.string().allow(''),
                    ...
                    item_id: Joi.array().items(Joi.string().allow('')),
        ...
        static PromotionListItem(){
            ...
            return Joi.object({
                    ...
                    buy_rules: Joi.object().pattern(/^/,this.ItemCriteria()).required(),
        ...
        class CatalogValidator {
            ...
            static getProducts(){
                ...
                return Joi.object({
                  ...
                  itemCode: Joi.array().items(Joi.number()),
                  q: Joi.string().allow(''),
                  tags: Joi.array().items(Joi.string().allow('')),
                  pageNo: Joi.number(),
                  pageSize: Joi.number(),
