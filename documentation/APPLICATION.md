...
```javascript
// Promise
const promise = catalog.getAppStores( {  pageNo : value,
 pageSize : value,
 q : value,
 city : value,
 range : value,
...
// Async/Await
const data = await catalog.getAppStores( {  pageNo : value,
 pageSize : value,
 q : value,
 city : value,
 range : value,
...
---
 ...
 | name | string |  no  |  |
 | email | string |  no  |  |
 | mobile_no | [PhoneNumber](#PhoneNumber) |  yes  |  |
...
---
 ...
 | contact_numbers | [[PhoneNumber](#PhoneNumber)] |  no  |  |
