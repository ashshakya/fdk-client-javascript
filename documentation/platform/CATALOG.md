...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").catalog.upsertAppProductMeta({  itemId : value,
 body : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").catalog.upsertAppProductMeta({  itemId : value,
 body : value });
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- | 
| itemId | string | yes | product id for which the custom_meta is assiciated. |  
...
| uid | number | no | Use this parameter to filter brands by  brand uid. |  
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | landscape_web | [CollectionImage](#CollectionImage) |  yes  |  |
 | landscape_mobile | [CollectionImage](#CollectionImage) |  yes  |  |
 | portrait_web | [CollectionImage](#CollectionImage) |  yes  |  |
 | portrait_mobile | [CollectionImage](#CollectionImage) |  yes  |  |
 | custombanner | [[CustomBanner](#CustomBanner)] |  no  |  |
